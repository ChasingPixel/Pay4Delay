package md54a8867112eee508f3a7d1c47230ef7f8;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ListViewSwipeItem.GestureListener, Pay4Delay, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GestureListener.class, __md_methods);
	}
	...
	public GestureListener () throws java.lang.Throwable
	{
		...
		if (getClass () == GestureListener.class)
			mono.android.TypeManager.Activate ("ListViewSwipeItem.GestureListener, Pay4Delay, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
